...
export default function Card({article}){
   ...
   return (  
   <div className="hover:filter:opacity(0) flex flex-col justify-end max-w-xs bg-white shadow-lg rounded-lg overflow-hidden my-10">
  ...
  <div className="flex items-center justify-between  px-4 py-2 bg-indigo-900">
    <h1 className="text-gray-200 font-bold self-end text-xl">{article.price} €</h1>
